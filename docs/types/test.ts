...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	ddot.main( '10', x, 1, y, 1 ); // $ExpectError
	ddot.main( true, x, 1, y, 1 ); // $ExpectError
	ddot.main( false, x, 1, y, 1 ); // $ExpectError
	ddot.main( null, x, 1, y, 1 ); // $ExpectError
	ddot.main( undefined, x, 1, y, 1 ); // $ExpectError
	ddot.main( [], x, 1, y, 1 ); // $ExpectError
	ddot.main( {}, x, 1, y, 1 ); // $ExpectError
	ddot.main( ( x: number ): number => x, x, 1, y, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a Float64Array...
{
	...
	ddot.main( x.length, 10, 1, y, 1 ); // $ExpectError
	ddot.main( x.length, '10', 1, y, 1 ); // $ExpectError
	ddot.main( x.length, true, 1, y, 1 ); // $ExpectError
	ddot.main( x.length, false, 1, y, 1 ); // $ExpectError
	ddot.main( x.length, null, 1, y, 1 ); // $ExpectError
	ddot.main( x.length, undefined, 1, y, 1 ); // $ExpectError
	ddot.main( x.length, [], 1, y, 1 ); // $ExpectError
	ddot.main( x.length, {}, 1, y, 1 ); // $ExpectError
	ddot.main( x.length, ( x: number ): number => x, 1, y, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a number...
{
	...
	ddot.main( x.length, x, '10', y, 1 ); // $ExpectError
	ddot.main( x.length, x, true, y, 1 ); // $ExpectError
	ddot.main( x.length, x, false, y, 1 ); // $ExpectError
	ddot.main( x.length, x, null, y, 1 ); // $ExpectError
	ddot.main( x.length, x, undefined, y, 1 ); // $ExpectError
	ddot.main( x.length, x, [], y, 1 ); // $ExpectError
	ddot.main( x.length, x, {}, y, 1 ); // $ExpectError
	ddot.main( x.length, x, ( x: number ): number => x, y, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fourth argument which is not a Float64Array...
{
	...
	ddot.main( x.length, x, 1, 10, 1 ); // $ExpectError
	ddot.main( x.length, x, 1, '10', 1 ); // $ExpectError
	ddot.main( x.length, x, 1, true, 1 ); // $ExpectError
	ddot.main( x.length, x, 1, false, 1 ); // $ExpectError
	ddot.main( x.length, x, 1, null, 1 ); // $ExpectError
	ddot.main( x.length, x, 1, undefined, 1 ); // $ExpectError
	ddot.main( x.length, x, 1, [], 1 ); // $ExpectError
	ddot.main( x.length, x, 1, {}, 1 ); // $ExpectError
	ddot.main( x.length, x, 1, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a fifth argument which is not a number...
{
	...
	ddot.main( x.length, x, 1, y, '10' ); // $ExpectError
	ddot.main( x.length, x, 1, y, true ); // $ExpectError
	ddot.main( x.length, x, 1, y, false ); // $ExpectError
	ddot.main( x.length, x, 1, y, null ); // $ExpectError
	ddot.main( x.length, x, 1, y, undefined ); // $ExpectError
	ddot.main( x.length, x, 1, y, [] ); // $ExpectError
	ddot.main( x.length, x, 1, y, {} ); // $ExpectError
	ddot.main( x.length, x, 1, y, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	ddot.main(); // $ExpectError
	ddot.main( x.length ); // $ExpectError
	ddot.main( x.length, x ); // $ExpectError
	ddot.main( x.length, x, 1 ); // $ExpectError
	ddot.main( x.length, x, 1, y ); // $ExpectError
...
// The compiler throws an error if the `ndarray` method is provided a first argument which is not a number...
{
	...
	ddot.ndarray( '10', x, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( true, x, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( false, x, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( null, x, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( undefined, x, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( [], x, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( {}, x, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( ( x: number ): number => x, x, 1, 0, y, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a second argument which is not a Float64Array...
{
	...
	ddot.ndarray( x.length, 10, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, '10', 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, true, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, false, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, null, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, undefined, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, [], 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, {}, 1, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, ( x: number ): number => x, 1, 0, y, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a third argument which is not a number...
{
	...
	ddot.ndarray( x.length, x, '10', 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, true, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, false, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, null, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, undefined, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, [], 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, {}, 0, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, ( x: number ): number => x, 0, y, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a fourth argument which is not a number...
{
	...
	ddot.ndarray( x.length, x, 1, '10', y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, true, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, false, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, null, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, undefined, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, [], y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, {}, y, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, ( x: number ): number => x, y, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a fifth argument which is not a Float64Array...
{
	...
	ddot.ndarray( x.length, x, 1, 0, 10, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, '10', 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, true, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, false, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, null, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, undefined, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, [], 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, {}, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, ( x: number ): number => x, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a sixth argument which is not a number...
{
	...
	ddot.ndarray( x.length, x, 1, 0, y, '10', 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, true, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, false, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, null, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, undefined, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, [], 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, {}, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, ( x: number ): number => x, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a seventh argument which is not a number...
{
	...
	ddot.ndarray( x.length, x, 1, 0, y, 1, '10' ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1, true ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1, false ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1, null ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1, undefined ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1, [] ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1, {} ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided an unsupported number of arguments...
{
	...
	ddot.ndarray(); // $ExpectError
	ddot.ndarray( x.length ); // $ExpectError
	ddot.ndarray( x.length, x ); // $ExpectError
	ddot.ndarray( x.length, x, 1 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1 ); // $ExpectError
	ddot.ndarray( x.length, x, 1, 0, y, 1, 0, 10 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	ddot.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	ddot.Module( '10' ); // $ExpectError
	ddot.Module( true ); // $ExpectError
	ddot.Module( false ); // $ExpectError
	ddot.Module( null ); // $ExpectError
	ddot.Module( undefined ); // $ExpectError
	ddot.Module( [] ); // $ExpectError
	ddot.Module( {} ); // $ExpectError
	ddot.Module( ( x: number ): number => x ); // $ExpectError
}
