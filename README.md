...
```javascript
ddot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-ddot@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-wasm-ddot/tags). For example,

```javascript
ddot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-ddot@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ddot = require( 'path/to/vendor/umd/blas-base-wasm-ddot/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-ddot@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-base-wasm-ddot.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-base-wasm-ddot

[test-image]: https://github.com/stdlib-js/blas-base-wasm-ddot/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-wasm-ddot/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-base-wasm-ddot/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-base-wasm-ddot?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-base-wasm-ddot.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-base-wasm-ddot/main
...
[branches-url]: https://github.com/stdlib-js/blas-base-wasm-ddot/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-base-wasm-ddot/main/LICENSE
